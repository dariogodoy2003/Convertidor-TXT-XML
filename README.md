...
### [Abrir Manual de Usuario PDF](https://dariogodoy2003.github.io/Convertidor-TXT-XML/docs/manual/Manual_de_uso_Conversor-TXT-XML.pdf)
...
# English
## TXT-XML-Converter
Open source software for converting MALDI-TOF peak lists generated by Vitek MS / Saramis RUO from `.txt` files into XML format compatible with the public MicrobeNet database.

---

## Main features
- TXT to XML conversion
- MicrobeNet compatibility
...
### [Official project page](https://dariogodoy2003.github.io/Convertidor-TXT-XML/)

---

## User manual

### [Open User Manual PDF](https://dariogodoy2003.github.io/Convertidor-TXT-XML/manual/Manual_de_uso_Conversor-TXT-XML.pdf)
