...
![Status: Stable](https://img.shields.io/badge/Status-v1.0_Stable-green.svg)
![Jurisdiction: Argentina](https://img.shields.io/badge/Registro-DNDA_Argentina-orange.svg)
...
<p align="center">
  <img src="docs/screenshots/main.png" alt="Pantalla principal del Convertidor" width="800" style="border-radius: 10px; box-shadow: 0 4px 8px rgba(0,0,0,0.2);">
</p>
...
| :--- | :--- |
| **Entrada** | Archivos `.txt` (Listas de picos) |
| **Salida** | Archivos `.xml` (Esquema MicrobeNet) |
| **Seguridad** | Procesamiento en entorno local, sin telemetría |
| **Instalación** | Instalador unificado (.exe) de ~100MB |
| **Arquitectura** | Optimizado para Windows 64 bits |
...
Para garantizar que el software no ha sido alterado, verifique la suma de comprobación del instalador:
